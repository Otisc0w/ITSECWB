...
public class ClientHome extends javax.swing.JPanel {
    ...
    public void init(SQLite sqlite, int role, String username){
        mgmtHistory = new MgmtHistory(sqlite, role, username);
        mgmtProduct = new MgmtProduct(sqlite, role, username);
