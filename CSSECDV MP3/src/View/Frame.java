...
//        Content.add(clientHomePnl, "clientHomePnl");
    ...
    public void mainNav(int role, String username){
        ...
        switch(role){
            ...
            case 2: // client
                ...
                clientHomePnl.init(main.sqlite, 2, username);
            ...
            case 3: // staff
                ...
                staffHomePnl.init(main.sqlite, 3, username);
            ...
            case 4: // Manager
                ...
                managerHomePnl.init(main.sqlite, 4, username);
            ...
            case 5: // Administrator
                ...
                adminHomePnl.init(main.sqlite, 5, username);
    ...
    public void forgotpassNav(){
        System.out.print("function werked");
    ...
    public void registerAction(String username, String password, String confpass){
        ...
        main.sqlite.addLogs("NOTICE", username, "User creation successful", formattedDateTime);
    }
